...
namespace ProjectTracker.DataAccess.Migrations
{
    ...
    [Migration("20220720081528_add_users")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectTracker.Domain.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartedDate = new DateTime(2022, 7, 20, 11, 15, 27, 717, DateTimeKind.Local).AddTicks(5664)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            StartedDate = new DateTime(2022, 7, 20, 11, 15, 27, 717, DateTimeKind.Local).AddTicks(5667)
                        });
                });
            ...
            modelBuilder.Entity("ProjectTracker.Domain.ProjectTask", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ExpectedDate = new DateTime(2022, 7, 27, 11, 15, 27, 717, DateTimeKind.Local).AddTicks(5615),
                            IsCompleted = false,
                        ...
                        new
                        {
                            ...
                            ExpectedDate = new DateTime(2022, 8, 4, 11, 15, 27, 717, DateTimeKind.Local).AddTicks(5645),
                            IsCompleted = false,
                            Name = "API Yazılacak",
                            ProjectId = 1
                        },
                        new
                        {
                            ...
                            ExpectedDate = new DateTime(2022, 7, 27, 11, 15, 27, 717, DateTimeKind.Local).AddTicks(5651),
                            IsCompleted = false,
                        ...
                        new
                        {
                            Id = 4,
                            Description = "....",
                            ExpectedDate = new DateTime(2022, 7, 23, 11, 15, 27, 717, DateTimeKind.Local).AddTicks(5655),
                            IsCompleted = false,
            ...
            modelBuilder.Entity("ProjectTracker.Domain.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
